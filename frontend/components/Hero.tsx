  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-[90vw] md:max-w-5xl">
        ...
        <h1 ref={titleRef} className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-serif font-bold tracking-tighter leading-[0.9] mb-8 md:mb-10 text-stone-900 dark:text-white will-change-premium break-words">
